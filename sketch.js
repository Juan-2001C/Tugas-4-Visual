...
function setup() {
  ...
  v = new Pesawat(300,400);
  u = new Pesawatdua(400,300);
}
...
class Pesawat{
  ...
  strokeWeight(1)
  fill("#16EBF3")
   ellipse (-60, this.l/200, 150, -this.l/2, this.l,0)
   fill("#E0CE1A")
  ellipse ( -40,this.l/100, 20,20, -this.l, 20,10)
   fill("#1CE612")
   ellipse ( -30,this.l/10, 15,100, -this.l/2,0,10)
   fill("#DA290D")
   ellipse ( -90,this.l/10, 15,50, -this.l/2,0,10)
